...
public class DatabaseConfig {
    ...
    /**
     * Ruta del archivo de base de datos. Puede sobrescribirse mediante la propiedad de sistema {@code buscadocs.db.url} evitando así modificar el archivo real de la aplicación.
     */
    private static final String DB_URL = System.getProperty("buscadocs.db.url", "jdbc:sqlite:buscadocs.db");
